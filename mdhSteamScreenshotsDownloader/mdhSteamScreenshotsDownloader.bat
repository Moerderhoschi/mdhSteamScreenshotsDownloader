...
goto oStart
///////////////////////////////////////////////////////////////////////////////////////////////////
// mdhSteamScreenshotsDownloader(by Moerderhoschi) v2025-05-26
...
:oStart
echo ------------------------------------------------------------------------------------------------------------------------------------
echo mdhSteamScreenshotsDownloader(by Moerderhoschi) v2025-05-26 - github: https://github.com/Moerderhoschi/mdhSteamScreenshotsDownloader
echo ------------------------------------------------------------------------------------------------------------------------------------
...
for %%g in (*_screenshots_20*.jpg) do (
set _g=%%g
